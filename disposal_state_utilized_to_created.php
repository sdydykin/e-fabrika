<?php
	...
	if($disposal_user_id != $user_id)
		die("Ошибка возврата элементов на склад");
			
	//Исключаем возможможность повторного возврата элементов на склад
	...
	mysqli_query($db, "UPDATE disposal_list SET status = 'CREATED' WHERE id = \"$id\"");
