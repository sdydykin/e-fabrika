...
<html lang="en">
	<head>
		...
		<title>Ведомость списания элементов</title>
	</head>
	<body>   
		<div class = "container">
			<div class = "row">
				<div class = "col-12">
					...
					?>	
					<div class='mb-3'>
						<h4>Ведомость списания элементов</h4>
					</div>	
<?php
	...
	if($disposal_user_id != $user_id)
		die("Ошибка формирования ведомости списания элементов");
			
	//Исключаем возможможность формирования ведомости на списание элементов для не забранных со склада элементов
	...
	$query_result = mysqli_query($db,  "SELECT 
										...
										ORDER BY part_type.name, part_list.storage");
	...
	{							
		...
		for($i = 0; $i < $row_count; $i++)
		{
			...
			$total_part_count = round($row['total_part_count'], 2);
		...
		echo "				<tr class='mb-4'> 
								<td colspan=4>Нет элементов для формирования ведомости</td>
							</tr>"; 
